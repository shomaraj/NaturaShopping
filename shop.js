...
var quantityInputs = document.getElementsByClassName('cart-input')[0];
...
console.log(removeCartItemButtons);
    ...
    function buynowClicked() {
      ...
      var totalPay= document.getElementsByClassName('cart-total-price')[0].innerText;
              alert("Proceeding to checkout...You have to pay "+ totalPay);
        updateCartTotal();
    }
...
addItemToCart(product_title, product_price, product_imgsrc);
}

function addItemToCart(product_title, product_price, product_imgsrc) {
  // window.ation.href="cart.html";
